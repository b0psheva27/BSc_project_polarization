...
topic_info.to_csv("output/weekly_topics_oldmodel_2.csv", sep="\t", index=False)
...
messages_df.to_csv("output/weekly_data_oldmodel_2.csv", sep=",")
...
monthly_messages_df.to_csv("output/monthly_data_oldmodel_2.csv", sep=",")
