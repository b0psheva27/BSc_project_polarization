...
def apply_pca2(merged_df, colume_list, n_components): 
    ...
    merged_df["pca_component1"], merged_df["pca_component2"] = zip(*pca.fit_transform(merged_df[colume_list]))
    return merged_df
...
def apply_umap2(merged_df, column_list, n_components):
